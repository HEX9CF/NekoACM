...
基于人工智能大模型的 ACM-ICPC 神经网络引擎工具包，提供自动出题、生成测试用例和题解代码、虚拟评测、题目解析、题目翻译、AI 编程助手等功能。可以作为一个单独的服务运行，也可以作为模块集成到 Online Judge 系统中。

## 功能介绍

- **AI 编程助手**：一个为 ACM-ICPC 算法竞赛和 OI 信息学竞赛选手提供帮助的 AI 编程助手，提供数据结构与算法相关的指导。
- **题目解析**: 将其他格式的题目数据解析为 JSON 格式，支持任意题目格式，包括但不限于文本、HTML、XML、Markdown、JSON、YAML等。
- **题目生成**：根据用户提供的题目信息或题解生成 ACM-ICPC 算法题目。
- **测试用例生成**：根据用户提供的题目信息或题解生成测试用例。
...
| 生成测试用例 | POST | /api/testcase/generate | 用户  | 根据用户提供的题目信息或题解生成测试数据               |
